export const airFigmaLinks = {
  ...
  designSystem: "https://www.figma.com/design/D6XwtXxLfGueNa2O4fwkHy/AirIQ-Case-Study?node-id=1-264&t=2oaxYzmdtrjQjfOl-1",
  edgeCases:    "https://www.figma.com/design/64MuAcPHGp3vcWTQheTK5l/AIR-iQ-Desktop",
};
...
export const airHeroMetrics = [
  ...
  { value: "20", accent: "+", label: "Screens, desktop and mobile" }
];
...
export const airStorySummary = [
  ...
  { value: "2", label: "Platforms, desktop and mobile" },
...
export const airReflections = [
  ...
  { num: "02", text: "The design system paid for itself. Screens 10 to 20 were built 4x faster than screens 1 to 5" },
