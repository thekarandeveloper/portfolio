    ...
    <div class="journey-timeline">
      ...
      <div class="timeline-item" data-tl-delay="120">
        ...
        <div class="timeline-content">
          ...
          <p class="timeline-detail">Designed three distinct care experiences: an Alzheimer&rsquo;s support planner, an Autism companion with structured daily routines, and Memory Lane, a lessons platform for kids.</p>
        </div>
      </div>
      <div class="timeline-item" data-tl-delay="240">
        ...
        <div class="timeline-content">
          ...
          <p class="timeline-detail">Designed BiblioFi, a smart library management app that made discovering and borrowing books feel effortless. Led the end-to-end design from flows to final interface.</p>
        </div>
      </div>
      <div class="timeline-item" data-tl-delay="360">
        ...
        <div class="timeline-content">
          ...
          <p class="timeline-company">ISDP · Apple &amp; Infosys Program</p>
          <p class="timeline-detail">Selected for a 6-month Apple &amp; Infosys iOS development program. Wrote my first lines of code, shipped my first app, and somewhere in that process, realised I cared more about how it felt than how it worked. That was the shift.</p>
        </div>
      </div>
    </div>
  </div>
