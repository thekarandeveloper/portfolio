...
/* ── HERO ── */
.hero{min-height:100vh;display:grid;grid-template-columns:50% 50%;align-items:start;padding:11rem 200px 4rem 200px;gap:40px;position:relative;overflow:visible;}
